...
largey<-rep(0,(number^2))
for (i in 1:(number^2)){
  largey[i]<--1+2*(runif(1)> exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+
                                                           largex[i,4]-largex[i,5]+largex[i,6])) /
                     (1+exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+
                                                      largex[i,4]-largex[i,5]+largex[i,6]))       ))
}
...
realp<-rep(0,(number^2))
for (i in 1:(number^2)){
  realp[i]<-1-1*(exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+
                                               largex[i,4]-largex[i,5]+largex[i,6])) /
                   (1+exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+
                                                    largex[i,4]-largex[i,5]+largex[i,6]))       ))
}
...
realy<-rep(0,n)
for (i in 1:n){
  realy[i]<--1+2*(runif(1)> exp( coe*sum(x[i,1:6])*(1-x[i,1]+x[i,2]-x[i,3]+x[i,4]-x[i,5]+
                                                      x[i,6]) )/
...
xplus1<-realx[realy==1,]
xminus1<-realx[realy==-1,]

yplus1<-realy[realy==1]
yminus1<-realy[realy==-1]

cutplus1<-round(ss/9,0)
cutminus1<-round(ff/9,0)


underx<-realx
underx10<-rbind(xplus1[1:(1*cutplus1),],xminus1[1:(ff),])
underx20<-rbind(xplus1[1:(2*cutplus1),],xminus1[1:(8*cutminus1),])
...
undery<-realy
undery10<-c(yplus1[1:(1*cutplus1)],yminus1[1:(ff)])
undery20<-c(yplus1[1:(2*cutplus1)],yminus1[1:(8*cutminus1)])
...
bayespred<-rep(0,m)
for (i in 1:(m)){
  bayespred[i]<--1+2*(.5> exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+largex[i,4]-
                                                        largex[i,5]+largex[i,6]))/( 1+exp(coe*sum(largex[i,1:6])*(1-largex[i,1]+largex[i,2]-largex[i,3]+largex[i,4]-largex[i,5]
                                                                                                                  +largex[i,6]))       ))
}
...
jitters1<-sqrt(var(realx[,1]))*noise*(runif(8*ss)-.5) 
jitters2<-sqrt(var(realx[,2]))*noise*(runif(8*ss)-.5)
jitters3<-sqrt(var(realx[,3]))*noise*(runif(8*ss)-.5) 
jitters4<-sqrt(var(realx[,4]))*noise*(runif(8*ss)-.5) 
jitters5<-sqrt(var(realx[,5]))*noise*(runif(8*ss)-.5) 
jitters6<-sqrt(var(realx[,6]))*noise*(runif(8*ss)-.5) 
jitters7<-sqrt(var(realx[,7]))*noise*(runif(8*ss)-.5) 
jitters8<-sqrt(var(realx[,8]))*noise*(runif(8*ss)-.5) 
jitters9<-sqrt(var(realx[,9]))*noise*(runif(8*ss)-.5) 
jitters10<-sqrt(var(realx[,10]))*noise*(runif(8*ss)-.5) 


jitterf1<-sqrt(var(realx[,1]))*noise*(runif(8*ff)-.5) 
jitterf2<-sqrt(var(realx[,2]))*noise*(runif(8*ff)-.5)
jitterf3<-sqrt(var(realx[,3]))*noise*(runif(8*ff)-.5)
jitterf4<-sqrt(var(realx[,4]))*noise*(runif(8*ff)-.5)
jitterf5<-sqrt(var(realx[,5]))*noise*(runif(8*ff)-.5)
jitterf6<-sqrt(var(realx[,6]))*noise*(runif(8*ff)-.5)
jitterf7<-sqrt(var(realx[,7]))*noise*(runif(8*ff)-.5)
jitterf8<-sqrt(var(realx[,8]))*noise*(runif(8*ff)-.5)
jitterf9<-sqrt(var(realx[,9]))*noise*(runif(8*ff)-.5)
jitterf10<-sqrt(var(realx[,10]))*noise*(runif(8*ff)-.5)
...
runx10[,1]<-runx10[,1]+c(rep(0,n),jitterf1[1:(8*ff)])
runx10[,2]<-runx10[,2]+c(rep(0,n),jitterf2[1:(8*ff)])
runx10[,3]<-runx10[,3]+c(rep(0,n),jitterf3[1:(8*ff)])
runx10[,4]<-runx10[,4]+c(rep(0,n),jitterf4[1:(8*ff)])
runx10[,5]<-runx10[,5]+c(rep(0,n),jitterf5[1:(8*ff)])
runx10[,6]<-runx10[,6]+c(rep(0,n),jitterf6[1:(8*ff)])
runx10[,7]<-runx10[,7]+c(rep(0,n),jitterf7[1:(8*ff)])
runx10[,8]<-runx10[,8]+c(rep(0,n),jitterf8[1:(8*ff)])
runx10[,9]<-runx10[,9]+c(rep(0,n),jitterf9[1:(8*ff)])
runx10[,10]<-runx10[,10]+c(rep(0,n),jitterf10[1:(8*ff)])
...
runx20[,1]<-runx20[,1]+c(rep(0,n),jitterf1[1:(7*ff)],jitters1[1:(1*ss)])
runx20[,2]<-runx20[,2]+c(rep(0,n),jitterf2[1:(7*ff)],jitters2[1:(1*ss)])
runx20[,3]<-runx20[,3]+c(rep(0,n),jitterf3[1:(7*ff)],jitters3[1:(1*ss)])
runx20[,4]<-runx20[,4]+c(rep(0,n),jitterf4[1:(7*ff)],jitters4[1:(1*ss)])
runx20[,5]<-runx20[,5]+c(rep(0,n),jitterf5[1:(7*ff)],jitters5[1:(1*ss)])
runx20[,6]<-runx20[,6]+c(rep(0,n),jitterf6[1:(7*ff)],jitters6[1:(1*ss)])
runx20[,7]<-runx20[,7]+c(rep(0,n),jitterf7[1:(7*ff)],jitters7[1:(1*ss)])
runx20[,8]<-runx20[,8]+c(rep(0,n),jitterf8[1:(7*ff)],jitters8[1:(1*ss)])
runx20[,9]<-runx20[,9]+c(rep(0,n),jitterf9[1:(7*ff)],jitters9[1:(1*ss)])
runx20[,10]<-runx20[,10]+c(rep(0,n),jitterf10[1:(7*ff)],jitters10[1:(1*ss)])
...
runx30[,1]<-runx30[,1]+c(rep(0,n),jitterf1[1:(6*ff)],jitters1[1:(2*ss)])
runx30[,2]<-runx30[,2]+c(rep(0,n),jitterf2[1:(6*ff)],jitters2[1:(2*ss)])
runx30[,3]<-runx30[,3]+c(rep(0,n),jitterf3[1:(6*ff)],jitters3[1:(2*ss)])
runx30[,4]<-runx30[,4]+c(rep(0,n),jitterf4[1:(6*ff)],jitters4[1:(2*ss)])
runx30[,5]<-runx30[,5]+c(rep(0,n),jitterf5[1:(6*ff)],jitters5[1:(2*ss)])
runx30[,6]<-runx30[,6]+c(rep(0,n),jitterf6[1:(6*ff)],jitters6[1:(2*ss)])
runx30[,7]<-runx30[,7]+c(rep(0,n),jitterf7[1:(6*ff)],jitters7[1:(2*ss)])
runx30[,8]<-runx30[,8]+c(rep(0,n),jitterf8[1:(6*ff)],jitters8[1:(2*ss)])
runx30[,9]<-runx30[,9]+c(rep(0,n),jitterf9[1:(6*ff)],jitters9[1:(2*ss)])
runx30[,10]<-runx30[,10]+c(rep(0,n),jitterf10[1:(6*ff)],jitters10[1:(2*ss)])
...
runx40[,1]<-runx40[,1]+c(rep(0,n),jitterf1[1:(5*ff)],jitters1[1:(3*ss)])
runx40[,2]<-runx40[,2]+c(rep(0,n),jitterf2[1:(5*ff)],jitters2[1:(3*ss)])
runx40[,3]<-runx40[,3]+c(rep(0,n),jitterf3[1:(5*ff)],jitters3[1:(3*ss)])
runx40[,4]<-runx40[,4]+c(rep(0,n),jitterf4[1:(5*ff)],jitters4[1:(3*ss)])
runx40[,5]<-runx40[,5]+c(rep(0,n),jitterf5[1:(5*ff)],jitters5[1:(3*ss)])
runx40[,6]<-runx40[,6]+c(rep(0,n),jitterf6[1:(5*ff)],jitters6[1:(3*ss)])
runx40[,7]<-runx40[,7]+c(rep(0,n),jitterf7[1:(5*ff)],jitters7[1:(3*ss)])
runx40[,8]<-runx40[,8]+c(rep(0,n),jitterf8[1:(5*ff)],jitters8[1:(3*ss)])
runx40[,9]<-runx40[,9]+c(rep(0,n),jitterf9[1:(5*ff)],jitters9[1:(3*ss)])
runx40[,10]<-runx40[,10]+c(rep(0,n),jitterf10[1:(5*ff)],jitters10[1:(3*ss)])
...
runx60[,1]<-runx60[,1]+c(rep(0,n),jitterf1[1:(3*ff)],jitters1[1:(5*ss)])
runx60[,2]<-runx60[,2]+c(rep(0,n),jitterf2[1:(3*ff)],jitters2[1:(5*ss)])
runx60[,3]<-runx60[,3]+c(rep(0,n),jitterf3[1:(3*ff)],jitters3[1:(5*ss)])
runx60[,4]<-runx60[,4]+c(rep(0,n),jitterf4[1:(3*ff)],jitters4[1:(5*ss)])
runx60[,5]<-runx60[,5]+c(rep(0,n),jitterf5[1:(3*ff)],jitters5[1:(5*ss)])
runx60[,6]<-runx60[,6]+c(rep(0,n),jitterf6[1:(3*ff)],jitters6[1:(5*ss)])
runx60[,7]<-runx60[,7]+c(rep(0,n),jitterf7[1:(3*ff)],jitters7[1:(5*ss)])
runx60[,8]<-runx60[,8]+c(rep(0,n),jitterf8[1:(3*ff)],jitters8[1:(5*ss)])
runx60[,9]<-runx60[,9]+c(rep(0,n),jitterf9[1:(3*ff)],jitters9[1:(5*ss)])
runx60[,10]<-runx60[,10]+c(rep(0,n),jitterf10[1:(3*ff)],jitters10[1:(5*ss)])
...
runx70[,1]<-runx70[,1]+c(rep(0,n),jitterf1[1:(2*ff)],jitters1[1:(6*ss)])
runx70[,2]<-runx70[,2]+c(rep(0,n),jitterf2[1:(2*ff)],jitters2[1:(6*ss)])
runx70[,3]<-runx70[,3]+c(rep(0,n),jitterf3[1:(2*ff)],jitters3[1:(6*ss)])
runx70[,4]<-runx70[,4]+c(rep(0,n),jitterf4[1:(2*ff)],jitters4[1:(6*ss)])
runx70[,5]<-runx70[,5]+c(rep(0,n),jitterf5[1:(2*ff)],jitters5[1:(6*ss)])
runx70[,6]<-runx70[,6]+c(rep(0,n),jitterf6[1:(2*ff)],jitters6[1:(6*ss)])
runx70[,7]<-runx70[,7]+c(rep(0,n),jitterf7[1:(2*ff)],jitters7[1:(6*ss)])
runx70[,8]<-runx70[,8]+c(rep(0,n),jitterf8[1:(2*ff)],jitters8[1:(6*ss)])
runx70[,9]<-runx70[,9]+c(rep(0,n),jitterf9[1:(2*ff)],jitters9[1:(6*ss)])
runx70[,10]<-runx70[,10]+c(rep(0,n),jitterf10[1:(2*ff)],jitters10[1:(6*ss)])
...
runx80[,1]<-runx80[,1]+c(rep(0,n),jitterf1[1:(1*ff)],jitters1[1:(7*ss)])
runx80[,2]<-runx80[,2]+c(rep(0,n),jitterf2[1:(1*ff)],jitters2[1:(7*ss)])
runx80[,3]<-runx80[,3]+c(rep(0,n),jitterf3[1:(1*ff)],jitters3[1:(7*ss)])
runx80[,4]<-runx80[,4]+c(rep(0,n),jitterf4[1:(1*ff)],jitters4[1:(7*ss)])
runx80[,5]<-runx80[,5]+c(rep(0,n),jitterf5[1:(1*ff)],jitters5[1:(7*ss)])
runx80[,6]<-runx80[,6]+c(rep(0,n),jitterf6[1:(1*ff)],jitters6[1:(7*ss)])
runx80[,7]<-runx80[,7]+c(rep(0,n),jitterf7[1:(1*ff)],jitters7[1:(7*ss)])
runx80[,8]<-runx80[,8]+c(rep(0,n),jitterf8[1:(1*ff)],jitters8[1:(7*ss)])
runx80[,9]<-runx80[,9]+c(rep(0,n),jitterf9[1:(1*ff)],jitters9[1:(7*ss)])
runx80[,10]<-runx80[,10]+c(rep(0,n),jitterf10[1:(1*ff)],jitters10[1:(7*ss)])
...
runx90[,1]<-runx90[,1]+c(rep(0,n),jitters1[1:(8*ss)])
runx90[,2]<-runx90[,2]+c(rep(0,n),jitters2[1:(8*ss)])
runx90[,3]<-runx90[,3]+c(rep(0,n),jitters3[1:(8*ss)])
runx90[,4]<-runx90[,4]+c(rep(0,n),jitters4[1:(8*ss)])
runx90[,5]<-runx90[,5]+c(rep(0,n),jitters5[1:(8*ss)])
runx90[,6]<-runx90[,6]+c(rep(0,n),jitters6[1:(8*ss)])
runx90[,7]<-runx90[,7]+c(rep(0,n),jitters7[1:(8*ss)])
runx90[,8]<-runx90[,8]+c(rep(0,n),jitters8[1:(8*ss)])
runx90[,9]<-runx90[,9]+c(rep(0,n),jitters9[1:(8*ss)])
runx90[,10]<-runx90[,10]+c(rep(0,n),jitters10[1:(8*ss)])
...
while(i<=iterations){
  ...
  print(c(i,te,error[i], undererror[i],linkerror[i],logerror[i],loglinkerror[i],misclass[i],te90,te10))
...
postscript("fhtmod2sqauredloss.ps")
...
postscript("fhtmod2f50plotlb.ps")
par(pty="s",cex.axis=2,cex.lab=2)
...
postscript("fhtmod2f70plotlb.ps")
par(pty="s",cex.axis=2,cex.lab=2)
...
postscript("fhtmod2f90plotlb.ps")
par(pty="s",cex.axis=2,cex.lab=2)
...
postscript("fhtmod2f50andf90plot.ps")
par(pty="s",cex.axis=2,cex.lab=2)
...
postscript("fhtmod2f50andf90plotlb.ps")
par(pty="s",cex.axis=2,cex.lab=2)
