...
while(i<=iterations){
  ...
  te<-sum(1*f*y<0)/n
  te90<-sum(1*underf90*undery90<0)/length(undery90)
  te10<-sum(1*underf10*undery10<0)/length(undery10)
  misclass[i]<-sum(1*largef*largey<0)/length(largef)
  
  
  print(c(i,te,undererror[i],linkerror[i],underlogerror[i],loglinkerror[i],misclass[i],te90,te10))
...
postscript("1000dundersqauredloss.ps")
par(pty="s",cex=1.5,cex.axis=1.8,cex.lab=2.5)
plot(c(iter,iter,iter),c(linkerror,lblinkerror,undererror),type="n",
     xlab="Iterations",ylab="Squared Loss")
points(0,linkerror[1],pch=19,cex=3)
...
postscript("1000dundermisclass.ps")
par(pty="s",cex=1.5,cex.axis=1.8,cex.lab=2.5)
...
postscript("1000dunderlogloss.ps")
par(pty="s",cex=1.5,cex.axis=1.8,cex.lab=2.5)
plot(c(iter,iter,iter),c(loglinkerror,lbloglinkerror,underlogerror),
     type="n",
     xlab="Iterations",ylab="Log Loss")
points(0,loglinkerror[1],pch=19,cex=3)
...
postscript("1000dunderexploss.ps")
par(pty="s",cex=1.5,cex.axis=1.8,cex.lab=2.5)
plot(c(iter,iter,iter),c(linkexploss,lblinkexploss,underexploss),
     type="n",
     xlab="Iterations",ylab="Exponential Loss")
points(0,linkexploss[1],pch=19,cex=3)
